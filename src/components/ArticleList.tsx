        ...
        <div className="flex mt-7 space-x-2.5 sm:space-x-4 lg:space-x-9">
          {
            topArticleList.map((article, index) => {
              return (
                <div key={index} className="flex flex-col rounded-xl border bg-white p-3 w-[320px] sm:w-[472px]">
                  ...
                  <div className="flex justify-between items-center mt-3">
                    ...
                    <div className="flex space-x-2 items-center">
                      ...
                      <span className="text-xs leading-none sm:text-sm font-bold">Maria Doe</span>
                    </div>
                  </div>
                  {/* Title */}
                  <div className="inline-flex sm:flex justify-between items-center mt-3">
                    <h1 className="inline-block sm:block text-[#22285E] text-[22px] sm:text-[22px] font-semibold">{article.title}</h1>
                    {
                      article.type === "created" &&
                      <span>
                        <button className={`bg-[#E3D5FF] text-[#7950F2] font-semibold rounded-md text-xs py-1.5 px-2.5 sm:text-base sm:py-2.5 sm:px-5 outline-none border-none`}>
                          Created
                        </button>
                      </span>
                    }
                    {
                      ...
                      <span>
                        <button className={`bg-[#E4FFF8] text-[#0DAD82] font-semibold rounded-md text-xs py-1.5 px-2.5 sm:text-base sm:py-2.5 sm:px-5 outline-none border-none`}>
                          Published
                        </button>
                      </span>
                    }
